---
title: Development Progress — Agent Tools & Provider Integration
summary: "Development roadmap, recent changes, and status."
weight: 100
---
...
> **Documentation index:** [README](https://github.com/riipandi/elph#readme) — architecture, configuration, CLI, slash commands, agent runtime, and a gap audit vs the codebase.
...
Detailed reference: [Tools § Provider API exposure](/guides/tools/#provider-api-exposure).
...
[Tools § Adding a new API-exposed tool](/guides/tools/#adding-a-new-api-exposed-tool).
...
Docs: [Tools § User approval](/guides/tools/#user-approval-huh), [TUI § Native tool detail](/guides/tui/#native-tool-detail).
...
See [README § Documentation gaps](https://github.com/riipandi/elph#readme#documentation-gaps-audit-summary) for the living gap list.
...
Docs: [Configuration § Directory layout](/configuration/configuration/#directory-layout), [Agent Runtime § Session and logging](/guides/agent-runtime/#session-and-logging).
...
Docs: [Tools § Provider API exposure](/guides/tools/#provider-api-exposure), [Consideration § Built-in tools](/customization/consideration/#built-in-tools).
...
Docs: [Slash Commands § Diagnostic detail boxes](/guides/slash-commands/#diagnostic-detail-boxes), [TUI § Slash Commands](/guides/tui/#slash-commands).
...
Docs: [Tools § User vision images](/guides/tools/#user-vision-images-tui-paste), [TUI § Image attachments](/guides/tui/#image-attachments), [Agent Runtime § User vision images](/guides/agent-runtime/#user-vision-images).
...
Docs: [TUI § Long text paste](/guides/tui/#long-text-paste), [TUI § AI response formatting](/guides/tui/#ai-response-formatting), [Configuration § settings.json](/configuration/configuration/#settingsjson).
...
Docs: [TUI § AI response formatting](/guides/tui/#ai-response-formatting), [Architecture § Performance](/guides/architecture/#performance-and-memory).
