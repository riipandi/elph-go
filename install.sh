...
#   --help               Show this help
#
# Also via env vars: ELPH_VERSION, ELPH_HOME, ELPH_INSTALL_DIR
# ---------------------------------------------------------------------------
set -euo pipefail
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    --version)
      ELPH_VERSION="$2"; shift 2 ;;
    --version=*)
      ELPH_VERSION="${1#*=}"; shift ;;
    --home)
      ELPH_HOME="$2"; shift 2 ;;
    --home=*)
      ELPH_HOME="${1#*=}"; shift ;;
    --install-dir)
      ELPH_INSTALL_DIR="$2"; shift 2 ;;
    --install-dir=*)
      ELPH_INSTALL_DIR="${1#*=}"; shift ;;
    --dry-run)
      ELPH_DRY_RUN=1; shift ;;
    --help)
      sed -n '3,16p' "$0"; exit 0 ;;
    *)
      echo "Unknown option: $1" >&2
      echo "Usage: $0 [--version <tag>] [--home <dir>] [--install-dir <dir>] [--dry-run] [--help]" >&2
      exit 1 ;;
  esac
done
